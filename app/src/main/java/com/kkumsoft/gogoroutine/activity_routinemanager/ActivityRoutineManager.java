...
import com.kkumsoft.gogoroutine.activity_routinemanager.Recycler.ActivityRoutineManagerAdapter;
import com.kkumsoft.gogoroutine.activity_routinemanager.Recycler.ActivityRoutineManagerAdapterDO;
import com.kkumsoft.gogoroutine.activity_routinemanager.Recycler.ItemTouchHelperCallback;
            ...
            btnComplete.setOnClickListener(new Button.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(adapter.list.size()<=0){
                        AlertDialog.Builder alert = new AlertDialog.Builder(ActivityRoutineManager.this);
                        alert.setTitle("주의");
                        alert.setMessage("최소한 습관 1개 이상은 추가되어야 합니다.");
                        alert.setPositiveButton("OK", null);
                        alert.show();
